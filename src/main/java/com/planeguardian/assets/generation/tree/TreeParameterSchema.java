...
public record TreeParameterSchema(int version, List<Parameter> parameters) {
    ...
    public static TreeParameterSchema current() {
        return new TreeParameterSchema(1, List.of(
                ...
                decimal("tree.branch.radius-ratio", "Branch radius ratio", "ratio", "[0.02, 0.8]", .09),
                decimal("tree.branch.elevation", "Branch elevation", "ratio", "[-0.5, 1]", .42),
                integer("tree.branch.ring-count", "Branch ring count", "count", "[2, 64]", 8),
                ...
                integer("tree.root.ring-count", "Root ring count", "count", "[2, 64]", 8),
