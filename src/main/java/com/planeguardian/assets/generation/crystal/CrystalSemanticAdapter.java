...
public final class CrystalSemanticAdapter implements AssetSemanticAdapter {
    ...
    public CrystalSemanticAssetProfile profile(SemanticProfile source) {
        ...
        var vfx = new CrystalSemanticAssetProfile.VfxDecoratorCharacter(PollenMotesVfxProvider.PLUGIN_ID, clamp01(0.05 + power.x() * power.salience() * 0.45 + rarity.x() * rarity.salience() * 0.25), List.of(
